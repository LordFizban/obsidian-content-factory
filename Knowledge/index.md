...
|:---|:---|:---:|:---|
| [[mark_graban]] | Person | ❄️ Cooled | Lean/Healthcare expert. Author of *Lean Hospitals*. Domain-aligned thought leader. 3 references in Q1. |
| [[fred_deichler]] | Person | ❄️ Cooled | AI practitioner (5,120 followers). Created Q1 breakthrough moment — 25 comments from industry leaders. |
...
|:---|:---|:---|
| [[authority_borrowing]] | Growth | Only proven follower conversion mechanism. Repost/tag thought leaders to trigger cross-network distribution. Cooling policy: max 2 refs/person/quarter. |
| [[stories_vs_frameworks]] | Content Quality | **#1 Q1 insight.** Story-grounded posts outperform abstract frameworks by 3.3x on reach. Non-negotiable rule for Q2. |
| [[turkish_content_strategy]] | Localization | Turkish = reach lever (549 imps), not conversation (0 comments). Monthly cadence. Translate top performers only. |
| [[cta_experiments]] | Engagement | Testing CTA formats to improve 0.5 comments/post avg. Q2 tests: explicit question, fill-in-blank, contrast question. |
