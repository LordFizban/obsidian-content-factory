...
|------|----------|------|----------------|----------------|------|--------|
| Em dashes | strict (max 1/post) | strict | strict | strict | relaxed | skip |
...
## Project-Specific Overrides (Agile Coach Brand)

> These additions are maintained locally and are not part of the upstream skill.
> When syncing from upstream, re-apply these after updating.

### Custom Addition 1: Staccato fragment chains (LinkedIn)

Sequences of 2-4 word dramatic sentences used for rhythmic effect in LinkedIn posts. This is distinct from the upstream "Manufactured punchlines and staccato drama" rule � that rule targets clipped fragments engineered as quotable closers, while this targets the shorter, more formulaic LinkedIn-specific pattern.

**What to flag:**
- "Two people. Two complaints. Opposite directions."
- "Same gap. Different angle."
- "One meeting. Three insights. Zero excuses."

**Fix:** Replace with natural compound sentences. "Two people raised opposite complaints" is clearer and doesn't trigger LinkedIn's AI slop classifiers.

**Severity:** P1

### Custom Addition 2: Em dash limit override (LinkedIn)

The upstream rule allows 1 em dash per 1,000 words, and the tolerance matrix relaxes this to 2/post for LinkedIn. For our content, **override to maximum 1 em dash per finished LinkedIn post**. LinkedIn's AI slop classifiers treat em dash density as a signal, and short-form posts (typically 200-400 words) amplify the per-word rate.

This override applies only to the linkedin context profile. Other profiles follow the upstream tolerance matrix.