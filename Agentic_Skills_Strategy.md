...
> **[Antigravity Awesome Skills](https://github.com/sickn33/antigravity-awesome-skills)** - 1,800+ universal agentic skills for Claude Code, Gemini CLI, Cursor, Copilot & more.

| Attribute | Value |
|-----------|-------|
| **Repo** | [sickn33/antigravity-awesome-skills](https://github.com/sickn33/antigravity-awesome-skills) |
| **Current Version** | v15.7.0 (Jul 29, 2026) |
| **Total Skills** | 1,800+ |
| **License** | MIT |
...
*Last Updated: 2026-08-02 (Sprint 1 System Hygiene + Q2 Strategy Review)*
*Community Repo Version at Last Check: v15.7.0*
*Knowledge Layer Version: v2.1 (counter-arguments, Dataview, rule maturity, file-back, dynamic analytics path)*
